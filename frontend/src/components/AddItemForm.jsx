            ...
            <form ref={formRef} onSubmit={onSubmit} className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3 mt-4">
                <button
                  ...
                  className="px-5 py-2 border border-gray-600 text-red-600 rounded-lg hover:bg-red-50 transition duration-200 font-medium cursor-pointer"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200 font-semibold disabled:opacity-50 cursor-pointer"
                >
                  {loading
                    ? "Saving..."
                    : editingMenuId
