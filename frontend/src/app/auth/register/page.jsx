...
//       setRestaurants(data.data || []);
//     } catch {
//       toast.error("Restaurant load failed.");
//     }
//   };
...
//       setBranches(data.data || []);
//     } catch {
//       toast.error("Branch load failed.");
//     }
//   };
...
//     for (let field of requiredFields) {
//       if (!form[field]) {
//         return toast.error(`Please fill ${field.replace("_", " ")}`);
//       }
//     }
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 flex items-center justify-center px-4 py-10">
//       <div className="w-full max-w-3xl bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl p-10 border border-amber-200/40">
        
//         <h1 className="text-center text-4xl font-extrabold text-amber-600 mb-8 tracking-wide">
//           Register New Admin
//         </h1>
...
//               className="p-3 rounded-xl bg-white border border-amber-200 focus:border-amber-500 focus:ring-2 
//                 focus:ring-amber-300 outline-none shadow-sm transition-all"
//             />
//           ))}
...
//             }
//             className="md:col-span-2 p-3 rounded-xl bg-white border border-amber-200 focus:border-amber-500 focus:ring-2 
//               focus:ring-amber-300 outline-none shadow-sm transition-all"
//           />
...
//           <button
//             type="submit"
//             className="md:col-span-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white 
//               py-3 rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.01] active:scale-95 
