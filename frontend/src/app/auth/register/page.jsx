      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#236B28]/10 backdrop-blur-md">
        ...
        `}
              ...
              <div className="pt-4 flex items-center justify-end gap-3">
                <button
                  type="submit"
                  className="px-6 py-1.5 bg-[#1C4D21] text-white rounded text-[14px] font-semibold hover:bg-[#143918] transition-all shadow-sm active:scale-95 cursor-pointer"
                >
